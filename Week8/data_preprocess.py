...
def count_vocab(dataset_dict):
    ...
    with open('./resources/vocabulary.pkl', 'wb') as f:
...
def dt_to_df(dataset_dict):
    ...
    export_to_file("./resources/crime_train.txt", dataset_dict['train'])
    export_to_file("./resources/crime_val.txt", dataset_dict['test'])
    train_data = tf.data.TextLineDataset("./resources/crime_train.txt")
    val_data = tf.data.TextLineDataset("./resources/crime_val.txt")
